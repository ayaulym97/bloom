...
export class approvedRequestSuccessfully extends Component {
    _func(isActive){
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <RkText style={styles.headerText}>ВАША ЗАЯВКА БЫЛА УСПЕШНО ПЕРЕСОЗДАНА!</RkText>
                    <RkText style={{fontSize: 12, textAlign: 'center', marginVertical:10}}>Ожидайте отклики от салонов и специалистов!</RkText>
